<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验室机位数" prop="shiyanshijiweishu">
          <el-input v-model="ruleForm.shiyanshijiweishu" 
              placeholder="实验室机位数" clearable  :readonly="ro.shiyanshijiweishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验室机位数" prop="shiyanshijiweishu">
              <el-input v-model="ruleForm.shiyanshijiweishu" 
                placeholder="实验室机位数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程详情" prop="kechengxiangqing">
          <el-input v-model="ruleForm.kechengxiangqing" 
              placeholder="课程详情" clearable  :readonly="ro.kechengxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程详情" prop="kechengxiangqing">
              <el-input v-model="ruleForm.kechengxiangqing" 
                placeholder="课程详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shiyanshimingcheng = true;
          ...
          if(o=='shiyanshijiweishu'){
            this.ruleForm.shiyanshijiweishu = obj[o];
	    this.ro.shiyanshijiweishu = true;
            continue;
          }
          if(o=='shuliang'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiyanxuanke/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiyanxuankeCrossAddOrUpdateFlag = false;
                  this.parent.search();
